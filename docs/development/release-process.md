...
The current public release is **v0.7.1**. Its maintenance closeout completed
only after its package, immutable tag, GitHub Release, and public consumers
were verified. Any future release requires a new Owner admission, accepted
