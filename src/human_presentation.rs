...
pub const fn catalog(locale: ResolvedLocale, key: HumanMessageKey) -> &'static str {
    match (locale, key) {
        ...
        (ResolvedLocale::EnUs, HumanMessageKey::Version) => "Version",
        ...
        (ResolvedLocale::EnUs, HumanMessageKey::Integrations) => "Integrations",
        (ResolvedLocale::EnUs, HumanMessageKey::Capabilities) => "Capabilities",
        (ResolvedLocale::EnUs, HumanMessageKey::Admission) => "Admission",
        (ResolvedLocale::EnUs, HumanMessageKey::ObservationBackend) => "Observation backend",
        (ResolvedLocale::EnUs, HumanMessageKey::ManualActions) => "Manual actions",
        ...
        (ResolvedLocale::ZhCn, HumanMessageKey::Version) => "版本",
        (ResolvedLocale::ZhCn, HumanMessageKey::CodexIntegration) => "Codex 集成",
        (ResolvedLocale::ZhCn, HumanMessageKey::Integrations) => "集成",
        (ResolvedLocale::ZhCn, HumanMessageKey::Capabilities) => "能力",
        (ResolvedLocale::ZhCn, HumanMessageKey::Admission) => "准入状态",
        (ResolvedLocale::ZhCn, HumanMessageKey::ObservationBackend) => "观测后端",
        (ResolvedLocale::ZhCn, HumanMessageKey::ManualActions) => "手动操作",
